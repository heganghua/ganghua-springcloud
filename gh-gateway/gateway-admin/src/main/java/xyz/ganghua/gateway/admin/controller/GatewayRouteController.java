...
public class GatewayRouteController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "网关路由", required = true, dataType = "String"),
            @ApiImplicitParam(name = "gatewayRouteForm", value = "网关路由实体", required = true, dataType = "GatewayRouteForm")})
    @ApiOperation(value = "根据id修改网关路由", notes = "修改指定网关路由信息")
    @PutMapping("/{id}")
